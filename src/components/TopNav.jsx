  ...
  console.log(sideNav)
    ...
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'> 
            ...
            <h2 className='text-2xl p-4'>Yum<span className='font-bold'>Eats</span></h2>
            <nav>
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl px-2">Yum<span className="font-bold">Eats</span>
            </h2>

            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
            <p className='bg-orange-700 text-white rounded-full p-2 text-[14px] ml-0'>Free</p>
        ...
        <button className="bg-orange-700 text-white hidden md:flex items-center px-4 py-1 rounded-full">
            <BsFillCartFill className="text-2xl ml-0 mr-1" size={18}/>
            Cart 
        </button> 
